...
- Extract claude-auth operations into ``ClaudeAuthVolumeHelper`` and config-volume operations into ``ConfigVolumeHelper``, reducing ``DockerSdkBackend`` from ~1400 to ~960 lines while keeping the public API unchanged.
