...
- Refactor `lifecycle/routers/services.py` (1837 lines) into four focused submodules: `service_crud.py`, `service_deploy.py`, `service_env.py`, `service_config.py`. Promoted `_deep_merge` helper to `_yaml_utils.py` as public `deep_merge`.
